...
import john.mod.objects.blocks.item.ItemBlockVariants;
import john.mod.util.handlers.EnumHandler;
import john.mod.util.interfaces.IHasModel;
import john.mod.util.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public BlockOres(String name, String dimension)
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.meteor));
