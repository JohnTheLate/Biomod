package john.mod.world.types.layer;
...
public class GenLayerCustom extends GenLayer
{
	...
	public GenLayerCustom(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, ChunkGeneratorSettings p_i45560_5_)
	{
		...
		biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(BiomeInit.ONUWAHI, 30));
		...
		if (p_i45560_4_ == WorldType.DEFAULT_1_1)
		{
			...
			biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(BiomeInit.ONUWAHI, 10));
			this.settings = null;
		}
		else
		{
